...
export const PRONUNCIATION_RULES = [
  ...
  },
  {
    id: 'syllabification',
    category: 'Stress',
    title: 'Syllable division — how to split Spanish words',
    rule: 'Spanish syllables follow consistent rules. Knowing them helps you predict stress, place accents correctly, and sound more natural. Every syllable has exactly one vowel or diphthong at its core.',
    sounds: [],
    tips: [
    ...
    examples: [
      { word: 'ca-sa', note: 'single consonant → goes with next syllable' },
      { word: 'can-tar', note: 'two consonants split: c-t → can | tar' },
      { word: 'li-bro', note: 'br cluster stays together → li | bro' },
      { word: 'pa-ís', note: 'i is weak but accent mark breaks diphthong → two syllables' },
      { word: 'bue-no', note: 'ue is a diphthong → one syllable' },
      { word: 'te-lé-fo-no', note: '4 syllables; accent on second: te-LÉ-fo-no' },
    ],
  },
  {
    id: 'rhythm_timing',
    category: 'Connected speech',
    title: 'Rhythm — Spanish is syllable-timed, English is stress-timed',
    rule: 'English compresses unstressed syllables (they rush) and stretches stressed ones, creating a "da-DUM-da-da-DUM" pattern. Spanish gives every syllable roughly equal duration — no syllable is rushed or reduced. This is the single biggest reason learners sound "English-accented" when speaking Spanish.',
    sounds: [],
    tips: [
      'Never reduce a vowel to "uh" (schwa). "para" = PAH-rah, not "puh-ruh".',
      'Every syllable takes roughly the same amount of time. "importante" has 4 equal beats: im-por-tan-te.',
      'Don\'t add stress to a syllable just because it carries semantic weight. In English, "VERY important" stresses both; in Spanish "muy importante" has even rhythm.',
      'Spanish speakers count syllables. English speakers count stresses. Think in syllables.',
      'In fast natural speech, Spanish still maintains syllable timing — it sounds fast because syllables are short and equal, not because unstressed ones are swallowed.',
    ],
    examples: [
      { word: 'pa-ra (equal)', note: 'PAH-rah (both syllables full), NOT "puh-ruh" (English-reduced)' },
      { word: 'im-por-tan-te (4 equal beats)', note: 'NOT "im-POR-tnt" (English compression)' },
      { word: 'uni-ver-si-dad (6 equal beats)', note: 'NOT "yoo-ni-VER-si-tee" (English pattern)' },
      { word: 'ca-ra-me-lo (4 equal beats)', note: 'stress on 3rd syllable only: ca-ra-ME-lo — others not reduced' },
    ],
  },
  {
