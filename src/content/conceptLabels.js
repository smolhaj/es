...
export const CONCEPT_LABELS = {
  ...
  // Added 09-09-2026: these 37 concepts had no label, so the dashboard,
  // history and session views were showing their raw ids. Surfaced by
  // `npm run check:content`.
  muy_vs_mucho: 'Muy vs. mucho',
  weather_expressions: 'Weather expressions',
  ordinal_numbers: 'Ordinal numbers (primero–décimo)',
  irregular_present_core: 'Core irregular present verbs (ser, tener, ir)',
  gustar_basico: 'Gustar (basic likes/dislikes)',
  prepositions_core: 'Core prepositions (a, de, en)',
  modal_verbs_core: 'Core modal verbs (poder, querer)',
  restaurant_ordering: 'Ordering at a café/restaurant (quisiera, la cuenta)',
  phone_plans: 'Phone calls & making plans',
  indefinite_pronouns: 'Indefinite pronouns (algo, alguien, alguno)',
  shopping_language: 'Shopping: prices, sizes, colors, trying things on',
  imperative_affirmative: 'Affirmative informal commands (tú)',
  relative_clauses_core: 'Core relative clauses (que, donde)',
  hotel_travel: 'Hotel check-in & travel logistics',
  directions_transport: 'Asking for directions & public transport',
  doctor_pharmacy: 'At the doctor & pharmacy',
  emergencies: 'Emergencies & getting help',
  bank_post_office: 'At the bank & post office',
  reciprocal_reflexives: 'Reciprocal reflexives (nos vemos, se quieren)',
  se_accidental: 'Accidental se (se me olvidó, se le rompió)',
  para_que: 'Purpose clauses (para que + subjunctive)',
  possessive_pronouns_stressed: 'Stressed possessive pronouns (el mío, la tuya)',
  estilo_indirecto_basico: 'Basic reported speech (dijo que...)',
  expresiones_probabilidad_basica: 'Certainty & doubt (deber de, es posible que)',
  small_talk: 'Small talk & catching up',
  correlative_comparatives: 'Correlative comparatives (cuanto más..., más...)',
  conectores_argumentativos_basicos: 'Basic argumentative connectors (pero, sin embargo, por eso)',
  registro_formal_correspondencia: 'Formal correspondence & polite requests',
  reformuladores_basico: 'Basic reformulators (o sea, es decir)',
  topic_shift_connectors: 'Topic-shift connectors (en cuanto a, con respecto a)',
  genero_informe: 'Formal genre: the informe (report)',
  technology_digital_life: 'Technology & digital life',
  environment_sustainability: 'Environment & sustainability',
  sequence_of_tenses: 'Sequence of tenses (concordancia de tiempos)',
  subjunctive_independent_clauses: 'Subjunctive in independent clauses (ojalá, quizá, tal vez)',
  verbos_pronominales: 'Pronominal verb nuance',
  superlative_absolute: 'Absolute superlative (-ísimo)',
};
