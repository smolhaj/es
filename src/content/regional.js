...
export const REGIONAL_SECTIONS = [
  ...
  },
  {
    ...
    tip: 'Leísmo only substitutes le for lo for masculine animate (people/male animals). Feminine and inanimate objects keep la/lo. You will hear "¿Le conoces?" and "¿Lo conoces?" from Spaniards — both mean "Do you know him?". In Latin America, only "¿Lo conoces?" is correct.',
  },
  {
    id: 'coger_regional',
    category: 'Vocabulary',
