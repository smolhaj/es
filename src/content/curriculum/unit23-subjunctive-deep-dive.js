...
export default {
  ...
  practice: [
    ...
    { type: 'fill_blank', prompt: 'Complete the nosotros form (remember the accent): "Si nosotros ___ (vivir) aquí..."', word: 'vivir', english: 'to live', answer: 'viviéramos', concept_id: 'imperfect_subjunctive', difficulty: 3 },
    ...
    { type: 'translation_to_english', prompt: '¿Qué significa "Habla como si lo supiera todo"?', word: 'como si', english: 'as if', answer: 'He talks as if he knew everything.', concept_id: 'imperfect_subjunctive', difficulty: 2 },
    { type: 'multiple_choice', prompt: 'Which sentence correctly uses a past-tense WEIRDO trigger?', word: 'emotion trigger (past)', english: 'I was glad you came', answer: 'Me alegré de que vinieras.', options: ['Me alegré de que vengas.', 'Me alegré de que vinieras.', 'Me alegro de que vinieras.', 'Me alegré de que vienes.'], concept_id: 'imperfect_subjunctive', difficulty: 3 },
    ...
    { type: 'error_correction', prompt: 'Find and correct the error: "Si llueva, no voy."', word: 'si_clauses (real condition)', english: 'real condition', answer: 'Si llueve, no voy.', concept_id: 'si_clauses', difficulty: 2 },
    ...
    { type: 'translation_to_english', prompt: '¿Qué significa "Si hubiera sabido, habría venido"?', word: 'Type 3 si-clause (preview)', english: 'contrary-to-past-fact', answer: "If I had known, I would have come.", concept_id: 'si_clauses', difficulty: 3 },
    { type: 'multiple_choice', prompt: 'Which type of si-clause is "Si hubiera sabido, habría venido"?', word: 'si_clauses (types)', english: 'contrary-to-past-fact', answer: 'Type 3 (contrary to past fact)', options: ['Type 1 (real condition)', 'Type 2 (present hypothetical)', 'Type 3 (contrary to past fact)', 'not a conditional sentence'], concept_id: 'si_clauses', difficulty: 2 },
    ...
    { type: 'translation_to_english', prompt: '¿Qué significa "En cuanto termina la clase, se va"?', word: 'en cuanto (habitual)', english: 'as soon as', answer: 'As soon as class ends, she leaves.', concept_id: 'subjunctive_adverbial', difficulty: 2 },
    ...
    { type: 'translation_to_english', prompt: '¿Qué significa "Dudo que hayan visto la película todavía"?', word: 'ver (irregular participle)', english: 'to see', answer: "I doubt they've seen the movie yet.", concept_id: 'perfect_subjunctive', difficulty: 2 },
