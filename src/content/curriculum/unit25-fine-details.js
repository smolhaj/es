...
export default {
  ...
  practice: [
    ...
    { type: 'translation_to_english', prompt: 'Translate: "La razón por la cual no vine fue el tráfico."', word: 'por la cual', english: "The reason I didn't come was the traffic.", answer: "The reason (for which) I didn't come was the traffic.", concept_id: 'relative_pronouns_advanced', difficulty: 3 },
    ...
    { type: 'translation_to_spanish', prompt: "Translate: 'My neighbor is very annoying.' (character trait)", english: 'My neighbor is very annoying.', answer: 'Mi vecino es muy molesto.', word: 'molesto', concept_id: 'adjectives_ser_estar', difficulty: 2 },
    { type: 'translation_to_spanish', prompt: "Translate: 'Are you upset with me?' (temporary state)", english: 'Are you upset with me?', answer: '¿Estás molesto conmigo?', word: 'molesto', concept_id: 'adjectives_ser_estar', difficulty: 2 },
    ...
    { type: 'translation_to_english', prompt: 'Translate: "¡Pobre hombre, perdió su trabajo!"', word: 'pobre', english: 'Poor guy, he lost his job!', answer: 'Poor guy, he lost his job! (pitiable, not broke)', concept_id: 'adjective_position', difficulty: 3 },
