...
export default {
  ...
  practice: [
    ...
    { type: 'translation_to_spanish', prompt: "Translate: 'I went to the party but I couldn\\'t stay long.' (ir, poder)", english: "I went to the party but I couldn't stay long.", answer: 'Fui a la fiesta pero no pude quedarme mucho tiempo.', word: 'fui / pude', concept_id: 'preterite_irregular', difficulty: 3 },
    ...
    { type: 'translation_to_english', prompt: '¿Qué significa "Mi abuelo siempre contaba las mismas historias"?', word: 'contaba', english: 'used to tell', answer: 'My grandfather always used to tell the same stories.', concept_id: 'imperfect', difficulty: 2 },
