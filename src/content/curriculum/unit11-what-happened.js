...
export default {
  ...
  practice: [
    ...
    { type: 'translation_to_spanish', prompt: "Translate: 'We spoke with the doctor yesterday.'", english: 'We spoke with the doctor yesterday.', answer: 'Hablamos con el doctor ayer.', word: 'hablamos', concept_id: 'preterite_regular', difficulty: 2 },
