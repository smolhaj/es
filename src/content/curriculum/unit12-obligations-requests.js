...
export default {
  ...
  practice: [
    ...
    { type: 'translation_to_spanish', prompt: "Translate: 'You (informal) have to finish the project by Friday.'", english: 'You have to finish the project by Friday.', answer: 'Tienes que terminar el proyecto para el viernes.', word: 'tener que', concept_id: 'obligation_infinitive', difficulty: 2 },
