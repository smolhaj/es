...
export default {
  ...
  practice: [
    ...
    { type: 'translation_to_spanish', prompt: "Translate, making the participle agree correctly: 'The bridge was designed by a famous architect.'", english: 'The bridge was designed by a famous architect.', answer: 'El puente fue diseñado por un arquitecto famoso.', altAnswers: ['El puente fue diseñado por una arquitecta famosa.'], word: 'fue diseñado', concept_id: 'passive_voice', difficulty: 3 },
    ...
    { type: 'translation_to_spanish', prompt: "Translate using passive se: 'Waiters are needed.' (plural)", english: 'Waiters are needed.', answer: 'Se necesitan camareros.', altAnswers: ['Se necesitan meseros.'], word: 'se necesitan', concept_id: 'passive_se', difficulty: 2 },
    { type: 'translation_to_english', prompt: 'Translate, noting this is impersonal se (no logical subject): "Se dice que el jefe se va."', word: 'se dice', english: "it's said / they say", answer: "It's said (people say) that the boss is leaving.", altAnswers: ['People say the boss is leaving.', 'People say that the boss is leaving.', 'They say the boss is leaving.'], concept_id: 'passive_se', difficulty: 3 },
