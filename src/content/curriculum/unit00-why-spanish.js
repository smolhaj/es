...
export default {
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "From here, this course takes you through 24 units, organized by the CEFR levels language schools use worldwide: A1 (absolute basics) through A2 (building fluency), B1 (expressing yourself), and B2 (advanced structures). Each unit teaches one or two grammar points at a time, explains the rule directly instead of making you guess it, and follows the explanation with practice exercises that make you produce the answer yourself — not just recognize it. That combination is what the research on language acquisition consistently points to as effective, and it's the same approach every unit after this one follows.",
