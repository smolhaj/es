...
export const UNIT_METADATA = [
  ...
  { id: 'argumentation-workplace', order: 25.1, level: 'B2', title: 'Argumentation & Workplace Correspondence',
    concepts: ['conectores_argumentativos_basicos', 'registro_formal_correspondencia', 'reformuladores_basico', 'genero_informe'],
    summary: 'Build a case with pero and sin embargo, then write it up in a proper formal email or report.' },
