...
export default {
  ...
  practice: [
    ...
    { type: 'translation_to_spanish', prompt: "Translate (the price is a known, agreed fact): 'Although it's expensive, I'm going to buy it.'", english: "Although it's expensive, I'm going to buy it.", answer: 'Aunque es caro, lo voy a comprar.', word: 'aunque es', concept_id: 'aunque_concessive', difficulty: 3 },
    ...
    { type: 'translation_to_english', prompt: 'Translate, noting the different pattern: "¿Qué piensas de esta idea?"', word: 'pensar de', english: 'What do you think of this idea?', answer: 'What do you think of this idea?', concept_id: 'verbos_preposicionales', difficulty: 3 },
