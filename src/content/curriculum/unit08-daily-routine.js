...
export default {
  ...
  practice: [
    ...
    { type: 'translation_to_english', prompt: '¿Qué significa "Nos duchamos por la mañana"?', word: 'ducharse', english: 'to shower', answer: 'We shower in the morning.', concept_id: 'reflexive_verbs', difficulty: 1 },
    ...
    { type: 'translation_to_spanish', prompt: "Translate: 'Her books are on the table.'", english: 'Her books are on the table.', answer: 'Sus libros están sobre la mesa.', word: 'su/sus', concept_id: 'possessives', difficulty: 2 },
