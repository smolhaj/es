...
const FEATURES = [
  ...
  {
    label: 'A1 to C1',
    body: 'A full curriculum built to CEFR standards — 71 tracked grammar concepts, 942 vocabulary items across 23 domains, 96 conjugated verbs, idioms, regional differences.'
  },
  {
  ...
  },
  {
    ...
    body: 'Grammar rules, verb conjugations, 120 idioms, false friends, pronunciation guide, and regional dialect differences — all searchable, no extra apps needed.'
  }
];
