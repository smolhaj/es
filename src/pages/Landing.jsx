...
const FEATURES = [
  ...
  {
    label: 'A1 to C1',
    body: 'A full curriculum built to CEFR standards — 62 tracked grammar concepts, 557 vocabulary items, idioms, regional differences, verb conjugation tables.'
  },
  {
  ...
  },
  {
    ...
    body: 'Grammar rules, verb conjugations, 84 idioms, false friends, pronunciation guide, and regional dialect differences — all searchable, no extra apps needed.'
  }
];
