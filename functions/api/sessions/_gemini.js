...
A1: greeting_basics, numbers_1_20, subject_pronouns, noun_gender, definite_articles,
    indefinite_articles, ser_basics, estar_basics, present_ar, present_er_ir,
    adjective_agreement, question_words, hay, numbers_21_100, plural_nouns, reflexive_verbs,
    demonstratives, possessives
A2: ser_vs_estar, gustar_type, direct_object_pronouns, indirect_object_pronouns,
    preterite_regular, modal_verbs, obligation_infinitive, time_expressions,
    present_progressive, irregular_present, negation, prepositions_basic, near_future,
    adverbs_formation, comparatives_basic, preterite_irregular, saber_vs_conocer,
    present_perfect
B1: acabar_de, llevar_gerund, imperfect, preterite_vs_imperfect, future_simple, conditional,
    present_subjunctive, imperative, por_vs_para, relative_clauses, object_pronoun_order,
    se_impersonal, infinitive_vs_subjunctive, exclamativas, lo_neutro, pluperfect, passive_se,
    subjunctive_adverbial, comparatives, cuantificadores, futuro_probabilidad,
    perifraseis_avanzadas, verbos_preposicionales
B2: future_perfect, conditional_perfect, passive_voice, imperfect_subjunctive, si_clauses,
    ser_estar_participle, diminutives_augmentatives, relative_pronouns_advanced,
    adjectives_ser_estar, perfect_subjunctive, verbos_cambio, adjective_position,
    estilo_indirecto_basico, expresiones_probabilidad_basica,
    conectores_argumentativos_basicos, registro_formal_correspondencia,
    subjunctive_adjective_clauses, condicional_probabilidad, pluperfect_subjunctive,
    aunque_concessive
C1: subjunctive_noun_clauses, gerund_advanced, ser_passive, estilo_indirecto, nominalisation,
    subjunctive_concessive_intensifiers, connectors_contrast, connectors_consequence,
    connectors_addition_sequence, connectors_cause_reason
C2: reformuladores, estructuradores_informacion, operadores_discursivos,
    registro_formal_informal, modalizacion_epistemica, controladores_contacto,
    subjunctive_indefinite_relative, subjunctive_rare_triggers, preterito_anterior,
    futuro_subjuntivo_relic, presente_historico_narrativo, dislocacion_topicalizacion,
    oraciones_hendidas, inversion_literaria, connotacion_denotacion, pares_registro_lexico,
    ironia_doble_sentido, implicatura_pragmatica, generos_discursivos_formales,
