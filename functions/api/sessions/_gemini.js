...
A1: greeting_basics, numbers_1_20, subject_pronouns, noun_gender,
    ...
    present_ar, present_er_ir, adjective_agreement, muy_vs_mucho,
    question_words, hay, weather_expressions, numbers_21_100,
    ordinal_numbers, plural_nouns, irregular_present_core, gustar_basico,
    prepositions_core, modal_verbs_core, obligation_infinitive, near_future,
    reflexive_verbs, demonstratives, possessives
A2: ser_vs_estar, gustar_type, restaurant_ordering, direct_object_pronouns,
    indirect_object_pronouns, preterite_regular, modal_verbs,
    time_expressions, phone_plans, present_progressive, irregular_present,
    negation, indefinite_pronouns, prepositions_basic, adverbs_formation,
    comparatives_basic, shopping_language, imperative_affirmative,
    relative_clauses_core, preterite_irregular, saber_vs_conocer,
    present_perfect, small_talk
B1: acabar_de, llevar_gerund, imperfect, preterite_vs_imperfect,
    hotel_travel, future_simple, conditional, present_subjunctive,
    imperative, directions_transport, doctor_pharmacy, emergencies,
    bank_post_office, por_vs_para, relative_clauses, object_pronoun_order,
    se_impersonal, reciprocal_reflexives, se_accidental,
    infinitive_vs_subjunctive, para_que, exclamativas, lo_neutro,
    possessive_pronouns_stressed, estilo_indirecto_basico,
    expresiones_probabilidad_basica, imperfect_subjunctive, si_clauses,
    pluperfect, passive_se, subjunctive_adverbial, comparatives,
    cuantificadores, superlative_absolute, futuro_probabilidad,
    perifraseis_avanzadas, verbos_preposicionales
B2: future_perfect, conditional_perfect, passive_voice,
    ser_estar_participle, diminutives_augmentatives,
    relative_pronouns_advanced, adjectives_ser_estar, perfect_subjunctive,
    verbos_cambio, adjective_position, correlative_comparatives,
    conectores_argumentativos_basicos, controladores_contacto,
    registro_formal_correspondencia, reformuladores_basico,
    operadores_discursivos, topic_shift_connectors, genero_informe,
    technology_digital_life, environment_sustainability,
    subjunctive_adjective_clauses, condicional_probabilidad,
    pluperfect_subjunctive, aunque_concessive
C1: subjunctive_noun_clauses, sequence_of_tenses,
    subjunctive_independent_clauses, verbos_pronominales, gerund_advanced,
    ser_passive, estilo_indirecto, nominalisation,
    subjunctive_concessive_intensifiers, connectors_contrast,
...
C2: reformuladores, modalizacion_epistemica,
...
A2: ser vs estar contrast, preterite (regular), reflexives, gustar-type verbs, object pronouns (direct/indirect), demonstratives, possessives, modal verbs, obligation (tener que/hay que), time expressions (hace/ayer/desde hace), present progressive (estar + gerund), irregular present tense (ir/tener/hacer/poder/venir/saber + yo-go + stem-changes), negation (no/nada/nadie/nunca double negatives), adverbs of manner (-mente formation), basic comparatives (más/menos...que, tan...como), present perfect, saber vs. conocer
B1: preterite irregular, imperfect, preterite vs imperfect, future, conditional, present subjunctive, imperative, por/para, relative clauses, acabar de, llevar + gerund, double object pronouns (me lo/se lo), impersonal se, infinitive vs subjunctive (same/different subject), exclamatory sentences (¡Qué!, ¡Cuánto!), neuter lo (lo + adjective, lo que), pluperfect, imperfect subjunctive, si-clauses, comparatives, quantifiers, subjunctive in adverbial clauses, advanced verb periphrases (soler, ponerse a, volver a, dejar de, llevar sin), verbs with fixed prepositions (pensar en, soñar con, consistir en)
B2: future perfect, conditional perfect, passive constructions (ser + participio, pasiva se), diminutives/augmentatives, advanced relative pronouns, present perfect subjunctive (haya + participio), verbs of change (ponerse/volverse/hacerse/llegar a ser), pluperfect subjunctive (hubiera/hubiese + participio), concessive aunque (indicative vs. subjunctive), adjective position (before/after noun) — only if CEFR level is B2+
C1: subjunctive in noun/adjective clauses, gerund (advanced), ser passive, indirect speech, nominalisation, concessive intensifiers (por más/mucho que — same mood rule as aunque, subjunctive is the standard/default choice), future/conditional for probability inference, discourse connectors (contrast: sin embargo/no obstante; consequence: por lo tanto/así que; addition: además/es más; cause: ya que/puesto que) — only if CEFR level is C1
