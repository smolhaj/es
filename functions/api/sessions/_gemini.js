...
A1: greeting_basics, numbers_1_20, subject_pronouns, noun_gender,
    ...
    prepositions_core, modal_verbs_core, reflexive_verbs, demonstratives,
    possessives
A2: ser_vs_estar, gustar_type, direct_object_pronouns,
    indirect_object_pronouns, preterite_regular, modal_verbs,
    obligation_infinitive, time_expressions, present_progressive,
    irregular_present, negation, prepositions_basic, near_future,
    adverbs_formation, comparatives_basic, imperative_affirmative,
...
B1: acabar_de, llevar_gerund, imperfect, preterite_vs_imperfect,
    ...
    infinitive_vs_subjunctive, exclamativas, lo_neutro, pluperfect,
    passive_se, subjunctive_adverbial, comparatives, cuantificadores,
    futuro_probabilidad, perifraseis_avanzadas, verbos_preposicionales
B2: future_perfect, conditional_perfect, passive_voice,
    imperfect_subjunctive, si_clauses, ser_estar_participle,
    diminutives_augmentatives, relative_pronouns_advanced,
    adjectives_ser_estar, perfect_subjunctive, verbos_cambio,
    adjective_position, estilo_indirecto_basico,
    expresiones_probabilidad_basica, conectores_argumentativos_basicos,
...
C2: reformuladores, estructuradores_informacion, operadores_discursivos,
    ...
    controladores_contacto, subjunctive_indefinite_relative,
